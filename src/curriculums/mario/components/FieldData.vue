<template>
  <article class="field-data" v-for="(field, index) of fields" :key="index">
    <div class="info-place">
      <div class="company font-bold">
        {{ typeof field.company === 'string' ? field.company : field.company.value }}
      </div>
      <div class="sub-company font-regular" v-if="field.subCompany">
        {{ field.subCompany }}
      </div>
