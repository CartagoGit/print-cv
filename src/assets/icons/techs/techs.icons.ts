import AndroidIcon from '@/assets/icons/techs/android.icon.svg';
...
import GithubIcon from '@/assets/icons/contact/github.icon.svg';
import GitlabIcon from '@/assets/icons/techs/gitlab.icon.svg';
...
import SassIcon from '@/assets/icons/techs/sass.icon.svg';
import SolidityIcon from '@/assets/icons/techs/solidity.icon.svg';
import TerminalIcon from '@/assets/icons/techs/terminal.icon.svg';
import TypescriptIcon from '@/assets/icons/techs/typescript.icon.svg';
